export const Button = ({
    ...
    const variants = {
        primary: "border-transparent text-white bg-primary-blue hover:bg-blue-600 focus:ring-primary-blue",
        secondary: "border-gray-300 text-dark bg-white hover:bg-gray-50 focus:ring-primary-blue",
